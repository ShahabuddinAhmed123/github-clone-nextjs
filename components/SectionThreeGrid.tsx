    ...
    <div className="w-full border-t border-gray-800" ref={container}>
      <div className="w-[1280px] mx-auto h-auto ">
        <div className="w-full grid grid-cols-3 gap-0 h-[585px] border-l border-b border-gray-800">
          ...
          <div className={`pt-16 pl-12 border-r border-gray-800 reveal-left flex flex-col justify-between ${monaSemibold.className}`} key={index}>
            <div>
        ...
        <div className="w-full h-auto flex gap-0 border-x border-b border-gray-800">
            ...
            <h1 className={`text-[40px] text-white reveal ${monaSemibold.className}`}>7x faster</h1>
            <p className="text-lg text-[#8b949e] font-semibold">vulnerability fixes with GitHub.</p>
            </div>
            <div className="py-24 px-12 w-1/2">
            <h1 className={`text-[40px] text-white reveal ${monaSemibold.className}`}>90% coverage</h1>
