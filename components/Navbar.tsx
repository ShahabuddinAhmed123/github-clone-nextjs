...
const Navbar = () => {
  ...
  return (
    ...
    >
      ...
      <Hamburger onClick={handleOpenResNav} isOpen={openResNav}/>
        <svg
          height="32"
          aria-hidden="true"
          viewBox="0 0 24 24"
        ...
        >
          ...
          {openedProduct && (
            ...
            >
              <div className="w-[284px] flex flex-col h-full pl-6 pr-12 border-r ">
        ...
        >
          ...
          {openedSolution && (
            ...
            >
              <div className="w-[350px] gap-5 grid grid-cols-2 h-full pl-6 pr-6 border-r">
