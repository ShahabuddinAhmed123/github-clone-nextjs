...
const Navbar = () => {
  ...
  return (
    <nav
      className={`text-white h-[72px] transition-all duration-500 w-screen fixed top-0 left-0 z-50 bg-transparent px-8 justify-between flex items-center ${
        scrolled ? "bg-[#151a22]" : "bg-transparent"
      }`}
    >
      <div className="flex items-center space-x-5">
        ...
        <div className="flex items-center relative space-x-2" onMouseOver={() => handleOpenEnterprise()}>
          <a href="#">Enterprise</a>
          <span>{arrow}</span>
      ...
      <div className="flex items-center space-x-6">
        <div className="w-[318px] h-8 flex items-center px-2 justify-between bg-[#272f49] rounded-md border border-gray-400">
          <CiSearch />
          <input
            className="w-[252px] h-full bg-transparent placeholder:text-sm pb-1 font-semibold"
            type="text"
