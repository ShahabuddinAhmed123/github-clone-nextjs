...
return (
<>
  <div ref={target} className={`${monaLight.className} text-white min-h-screen w-full flex flex-col items-center justify-center relative `}>
  {showNav &&  <div className="w-[970px] h-[80vh] flex justify-center fixed z-0">
    ...
    <div ref={videoDiv.ref} id="parallax" className="w-[1246px] h-fit absolute top-[85vh] bg-[#655e96] p-6 rounded-t-3xl border border-[#8c93fb] shadow-2xl shadow-[#8c93fb] flex justify-center items-center">
      <Video
        src={MainVideo}
        controls
        autoPlay
